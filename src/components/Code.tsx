  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-koiBlue-400/10 ring-1 ring-inset ring-koiBlue-400/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-koiBlue-400 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
            ...
            <Tab
              className={clsx(
                ...
                childIndex === selectedIndex
                  ? 'border-koiBlue-500 text-koiBlue-400'
