...
export const metadata = {
  ...
  description:
    'Overview of Koi\'s solution classification framework for climate technologies, covering direct, facilitating, and carbon dioxide removal categories used by the Koi Engine.',
}
