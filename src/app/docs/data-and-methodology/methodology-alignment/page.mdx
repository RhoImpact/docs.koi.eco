...
<div className="mt-12 overflow-x-auto">
  <table className="koi-table min-w-full">
    ...
    <tbody>
      ...
      <tr>
        <td><strong>GIC-Schroder</strong></td>
        <td className="text-center"><i className="fas fa-check text-koiGreen-500"></i></td>
      </tr>
      <tr>
        <td><strong>Goldman Sachs Carbonomics</strong></td>
        <td className="text-center"><i className="fas fa-check text-koiGreen-500"></i></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><strong>Systemic/ETC</strong></td>
        <td className="text-center"><i className="fas fa-check text-koiGreen-500"></i></td>
      </tr>
      <tr>
...
<p><ExternalLink url="https://www.schroders.com/en-us/us/institutional/insights/avoided-emissions/" target="_blank" rel="noopener noreferrer" linkText="A framework for avoided emissions analysis" /></p>
...
<p><ExternalLink url="https://www.goldmansachs.com/insights/pages/gs-research/carbonomics-affordability-security-and-innovation/report.pdf" target="_blank" rel="noopener noreferrer" linkText="Carbonomics: Affordability, Security and Innovation" /></p>
<PageInformationalData lastModified="2025-10-06" lastModifiedLabel="Last Reviewed:" className="my-0" />
...
<p><ExternalLink url="https://www.theice.com/publicdocs/ICE_Avoided_Emissions_White_Paper.pdf" target="_blank" rel="noopener noreferrer" linkText="From Climate Risk to Climate Opportunity: The Concept of Avoided Emissions" /></p>
<PageInformationalData lastModified="2025-10-06" lastModifiedLabel="Last Reviewed:" className="my-0" />
...
**Key Metrics:** Avoided emissions.

---

## PCAF

<p><ExternalLink url="https://carbonaccountingfinancials.com/standard" target="_blank" rel="noopener noreferrer" linkText="The Global GHG Accounting and Reporting Standard for the Financial Industry" /></p>
<PageInformationalData lastModified="2025-10-06" lastModifiedLabel="Last Reviewed:" className="my-0" />
...
<p><ExternalLink url="https://www.energy-transitions.org/publications/financing-the-transition/" target="_blank" rel="noopener noreferrer" linkText="Financing the Transition: How to Make the Money Flow for a Net-Zero Economy" /></p>
<PageInformationalData lastModified="2025-10-06" lastModifiedLabel="Last Reviewed:" className="my-0" />

> Top-down analysis of capital investments in technologies and assets required to reach net-zero.

**Key Metrics:** Capital investments in tech and assets to reach net-zero.
