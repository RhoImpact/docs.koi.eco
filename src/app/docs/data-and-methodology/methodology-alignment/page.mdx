...
<table className="mt-12 koi-table">
  <thead>
    <tr>
      ...
      <th className="text-center w-[18%]">Emissions<br />Intensities</th>
      <th className="text-center w-[18%]">Per Unit<br />Reduction</th>
      <th className="text-center w-[18%]">Industry<br />Application Selection</th>
      <th className="text-center w-[18%]">Market<br />Definition</th>
      <th className="text-center w-[18%]">Adoption<br />Rate</th>
    </tr>
  </thead>
