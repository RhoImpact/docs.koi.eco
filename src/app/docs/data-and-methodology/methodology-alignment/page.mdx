...
export const metadata = {
  ...
  description:
    'How Koi aligns with major avoided emissions frameworks including WBCSD, Project Frame, PCAF, CDP, and GFANZ, with a detailed compatibility matrix across methodology components.',
}
...
avoided emissions. We make these frameworks actionable. **Koi translates these
frameworks into scalable, production-grade infrastructure for real-world
decision-making**.
...
aligning with. We are proud to contribute to many of them. **Koi provides the
infrastructure to implement these frameworks at production scale**.
</Info>
...
Koi solutions are classified by intervention mechanism (e.g., [direct](/docs/data-and-methodology/classification-direct) vs. [facilitating](/docs/data-and-methodology/classification-facilitating)) for the purposes of automated modeling and appropriate baseline identification. All solutions with defined mechanisms of impact and measurable physical changes to systems are eligible for Koi modeling, regardless of their classification.
...
For how Expected Emissions Reductions and avoided emissions support a standardized net-zero transition plan, see [Transition Planning and Avoided Emissions](/docs/data-and-methodology/transition-planning).
...
<ExternalLink url="https://carbonaccountingfinancials.com/files/2024-consultation/PartA-Methods2024-Master-01-1.pdf" target="_blank" rel="noopener noreferrer" linkText="New guidance and methods for public consultation" />

Primarily focused on financed emissions tracking and reporting in alignment with the GHG Protocol, with its Standard formally recognized by the Protocol. Recent guidance expands to include financed avoided emissions and forward-looking metrics such as Expected Emissions Reductions (EER).
...
For how financed emissions and financed avoided emissions relate, and why they stay in separate ledgers, see [Financed Emissions and Avoided Emissions](/docs/data-and-methodology/financed-emissions).
