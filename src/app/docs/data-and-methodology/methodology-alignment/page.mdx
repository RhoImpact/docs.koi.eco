...
<div className="mt-12 overflow-x-auto">
  <table className="koi-table min-w-full">
    <thead>
      <tr>
        <th className="text-right w-[10%] min-w-[80px]"></th>
        <th className="text-center w-[18%] min-w-[120px]">Emissions<br />Intensities</th>
        <th className="text-center w-[18%] min-w-[120px]">Per Unit<br />Reduction</th>
        <th className="text-center w-[18%] min-w-[140px]">Industry<br />Application Selection</th>
        <th className="text-center w-[18%] min-w-[120px]">Market<br />Definition</th>
        <th className="text-center w-[18%] min-w-[100px]">Adoption<br />Rate</th>
      </tr>
    </thead>
