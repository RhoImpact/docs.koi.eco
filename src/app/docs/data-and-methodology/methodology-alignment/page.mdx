...
<table className="mt-12 koi-table">
  <thead>
    <tr>
      <th className="text-right"></th>
      <th className="text-center">Emissions Intensities</th>
      <th className="text-center">Per Unit Reduction</th>
      <th className="text-center">Industry Application Selection</th>
      <th className="text-center">Market Definition</th>
      <th className="text-center">Adoption Rate</th>
    </tr>
  </thead>
  <tbody className="text-center">
    <tr className="bg-koiGreen-400/10">
    ...
    <tr>
      <td className="text-right"><strong>WBCSD</strong></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
    ...
    <tr>
      <td className="text-right"><strong>Project Frame</strong></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
    ...
    <tr>
      <td className="text-right"><strong>Mission Innovation</strong></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
    ...
    <tr>
      <td className="text-right"><strong>GFANZ</strong></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
    ...
    <tr>
      <td className="text-right"><strong>CDP ECT</strong></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
    ...
    <tr>
      <td className="text-right"><strong>Mirova/Robeco<br />AEFDi AEP</strong></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
      <td><i className="fas fa-check text-koiGreen-500"></i></td>
    ...
    <tr>
      <td colSpan="6" className="text-center">
        ...
        Koi Alignment with Avoided Emissions Standards, Frameworks, &amp; Best Practices
        </span>
      </td>
    </tr>
  </tbody>
