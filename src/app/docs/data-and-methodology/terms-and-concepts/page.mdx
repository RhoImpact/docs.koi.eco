...
Avoided Emissions Factors (AEFs) are another way of expressing the same underlying metric as Unit Impact. While "Unit Impact" is often used in technical or methodological contexts (for example, by <a href="/docs/data-and-methodology/methodology-alignment">Project Frame</a>), "AEFs" are may referenced by organizations for standardized reporting and comparison (primarily within the <a href="/docs/data-and-methodology/methodology-alignment">AEFDi</a>). Both terms quantify the emissions avoided per unit of activity or output, but may be preferred by different audiences or target groups depending on context and familiarity. For more details on these methodological differences, see the <a href="/docs/data-and-methodology/methodology-alignment">Methodology Alignment</a> page.
