...
Avoided Emissions Factors (AEFs) are another way of expressing the same underlying metric as Unit Impact. While "Unit Impact" is often used in technical or methodological contexts (for example, by [Project Frame](/docs/data-and-methodology/methodology-alignment)), "AEFs" are may referenced by organizations for standardized reporting and comparison (primarily within the [AEFDi](/docs/data-and-methodology/methodology-alignment)). Both terms quantify the emissions avoided per unit of activity or output, but may be preferred by different audiences or target groups depending on context and familiarity. For more details on these methodological differences, see the [Methodology Alignment](/docs/data-and-methodology/methodology-alignment) page.
