...
export const metadata = {
  title: 'Koi Data',
  description:
    'Explore the data sources powering Koi\'s 9,000+ climate models, including the Koi Data Lake, major providers like IEA and EPA, and academic lifecycle analysis references.',
}
...
<InternalLink
  ...
  linkText="Koi Engine"
/>, LCA data are frequently used as templates for constructing solution GHG intensities and comparing solutions against established value chains. For how Koi structures these LCA inputs into segmented, market-aware value chains, see the [LCA Library](/docs/data-and-methodology/lca-library).
