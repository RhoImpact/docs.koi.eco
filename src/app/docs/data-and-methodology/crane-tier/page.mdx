...
export const metadata = {
  ...
  description:
    'The CRANE Tier is Koi\'s permanently free avoided emissions modeling capability, built on the CRANE methodology co-created with Prime Coalition. Same science, expanded infrastructure, zero cost. History, methodology continuity, and framework contributions.',
}
...
The **CRANE Tier** is Koi's permanently free avoided emissions modeling capability. It provides science-based, forward-looking GHG impact assessments for emerging climate technologies -- built on the CRANE methodology co-created with Prime Coalition and aligned with Project Frame's pre-investment GHG assessment guidance. Over 6,300 registered users have generated 123,500+ impact reports across 6,000+ technology models. The CRANE Tier is free, permanent, and available now at [koi.eco/pricing](https://koi.eco/pricing).
...
<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
  ...
  description: 'Free, permanently available avoided emissions modeling for emerging climate technologies. Science-based, forward-looking GHG impact assessments built on methodology co-created with Prime Coalition and aligned with Project Frame.',
...
CRANE's methodology is aligned with <ExternalLink url="https://projectframe.how/preinvestment-ghg-assessment" linkText="Project Frame's Pre-Investment GHG Assessment guidance" /> -- the consensus framework developed by a community of 1,300+ climate investors and practitioners, organized by Prime Coalition.
