...
export const metadata = {
  ...
  description:
    'How Koi classifies and models direct climate solutions -- products and components that avoid emissions by replacing higher-emitting incumbents in the value chain.',
}
