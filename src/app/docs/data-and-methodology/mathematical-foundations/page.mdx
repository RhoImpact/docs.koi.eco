...
export const metadata = {
  ...
  description:
    'The core avoided emissions formula behind every Koi model -- unit impact, solution scale, GHG intensity differentials, and how they combine for consistent, comparable impact forecasts.',
}
...
{/* See the [solution classification section](/docs/data-and-methodology/classification-overview) for information on how the equation components are determined for different solution types. */}
</Info>
...
<Tip>
The baseline scenario represents what would happen in the absence of the climate solution. This is a crucial consideration for calculating the most likely impact of the intervention. It might also be the case that one wants to consider a range of possibilities, where the most likely counterfactual scenario, or even other questions like appropriate functional unit, are uncertain, in which case a more statistical view of the outcomes might be most useful. Koi accommodates both of these approaches, with the former being more common than the latter.
</Tip>
...
Solution Scale represents the size of the solution market, measured in functional units (e.g., megawatt-hours of electricity, miles driven, tons of material processed, dollars).
