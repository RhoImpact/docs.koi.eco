...
export const metadata = {
  ...
  description:
    'How Koi classifies and models facilitating climate solutions -- technologies that enable emissions reductions indirectly, including modeling criteria and specificity requirements.',
}
