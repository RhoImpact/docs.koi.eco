...
export const metadata = {
  ...
  description:
    'Learn how avoided emissions are calculated in Koi, including the key factors -- GHG intensity, market size, and adoption rates -- that determine the emissions a climate solution prevents.',
}
...
Avoided emissions are the greenhouse gas emissions that are passively **prevented from**
being released into the atmosphere **as a result** of an intentional product deployment (sales), project or activity. This can be achieved through the implementation of
...
increasingly important metric for understanding the environmental impact of a project
and can help to anticipate the measurable benefits of sustainable practices by considering and quantifying plausible future scenarios.

Please refer to our list of [tracked methodologies](/docs/data-and-methodology/methodology-alignment).
...
where avoided emissions equal the area of the rectangle that is missing when the solution technology is introduced.
...
<YouTubeEmbed
  videoId="WluBdTozPwY"
  title="Understanding Unit Impact - Koi Platform"
  caption="Watch this explanation of how per unit impact affects avoided emissions"
/>
