...
## Definitions of Avoided Emissions

The concept of avoided emissions is still evolving, with no universally accepted definition.
However, significant efforts are underway to standardize it.
In the meantime, we are tracking the definitions that align most closely with our approach.


| Source                                             | Summary                   | <div align="center">Koi Compatible</div> |
|----------------------------------------------------|---------------------------|------------------------------------------|
| <a href="https://projectframe.how/glossary?utm_source=koi" target="_blank" rel="noopener noreferrer">Project Frame</a> | Avoided emissions are defined as the "positive" impact on society when comparing the GHG impact of a solution to an alternative reference scenario where the solution would not be used. They are sometimes referred to as Scope 4 Emissions, but Project Frame does not recommend the use of this term to avoid conflation with Scope 1, Scope 2, and Scope 3 used in carbon accounting. | <div align="center" className="text-green-500">&#x2713;</div> |
| <a href="https://www.carbontrust.com/what-we-do/net-zero-transition-planning-and-delivery/avoided-emissions?utm_source=koi" target="_blank" rel="noopener noreferrer">Carbon Trust</a> | Avoided emissions refer to the greenhouse gas emissions that have been 'avoided' by using a specific product or service, comparing it to a situation had the product or service not been used. | <div align="center" className="text-green-500">&#x2713;</div> |
...
<div className="koi-docs-image-container flex flex-wrap">
  <Image
    src={AE1}
    alt="Total baseline emissions visualization"
    className="koi-docs-image w-5/6 sm:w-1/3"
/>
  <Image
    src={AE2}
    alt="Total baseline emissions visualization"
