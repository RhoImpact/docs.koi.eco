import introAEImage from './images/1_Avoided_emissions_total_baseline.png'
import fullAnimation from './images/2_AE_animation_medium.gif'
...
export const metadata = {
  title: 'Factors that Determine Avoided Emissions',
  description:
    'Learn about the factors that determine the amount of avoided emissions can be attributed to a climate solution technology.',
}
