import { AvoidedEmissionsExplained } from '@/components/AvoidedEmissionsExplained'
...
Definitions and explanations for some of the important terms and concepts used in the Koi platform. {{ className: 'lead' }}

<AvoidedEmissionsExplained />
