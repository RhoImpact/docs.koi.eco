...
3. Produce **auditable, versioned** models that can contineu to be refined as companies scale.
</Tip>
...
/>  [roadmap](https://product.koi.eco/roadmap). If this is an important feature to you, please consider providing
