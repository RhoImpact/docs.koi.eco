...
That said, the concept continues to evolve, so it is important to understand the distinctions
among the various frameworks, methodologies, industry perspectives, and issued guidance.
Below is a summary of the key approaches we are most closely tracking and aligning with.
We are proud to contribute to many of them.

<Info>
While critical global initiatives focus on the academic and theoretical foundations of
avoided emissions, our role is to make these frameworks actionable. Koi turns
them into scalable, production-ready software used by enterprises, investors,
and innovators making real-world decisions.
</Info>
