...
export const metadata = {
  ...
  description: 'Frequently asked questions about Koi, covering platform capabilities, pricing, methodology, API access, data integrations, and support options.',
}
...
<FaqSection title="Getting Started & Overview">

<FaqItem question="Can I request a demo of Koi?">
...
<FaqItem question="Does Koi have a methodology?">
...
<FaqItem question="What is the pricing structure for Koi?">
...
<FaqItem question="How does Koi compare to other impact assessment tools?">
While many tools focus on measurement, **Koi is built for decision-making**. Our platform combines the rigor of established methodologies with the speed and scalability that modern climate finance demands. Unlike static calculators, reporting platforms, or rigid frameworks, Koi delivers flexible, collaborative analysis backed by a continuously expanding database of 9,000+ climate solution models. Portfolio-level insights, dynamic modeling, and transparent assumptions -- all aligned with global sustainability standards.
</FaqItem>

</FaqSection>

<FaqSection title="Platform Capabilities & Features">

<FaqItem question="What industries or sectors does Koi support?">
...
<FaqItem question="Can Koi integrate with external data sources and handle Excel uploads?">
...
<FaqItem question="What types of emissions does Koi track?">
...
<FaqItem question="What level of data granularity does Koi provide?">
Koi adapts to your analytical needs, from high-level strategic insights to granular operational details. While our platform excels at technology- and company-level impacts across multiple assets and geographies, we can also zoom in to asset-level specificity when your decisions demand it. This flexibility allows users to analyze emissions and impact across company portfolios, industry sectors, or individual investments -- all within a single, consistent methodology that scales from boardroom presentations to technical due diligence.
</FaqItem>

<FaqItem question="Does Koi offer API access for automated workflows?">
Absolutely -- our API provides programmatic access to Koi's climate data and modeling engine for integration into your existing workflows. Currently in beta, our API enables automated impact assessments, bulk analysis, and custom integrations that fit your operational needs. See our [API reference docs](/docs/api/reference) for technical details, and reach out to us at <ExternalLink url="mailto:hello@koi.eco" linkText="hello@koi.eco" /> to discuss how we can support your specific automation requirements.
</FaqItem>

<FaqItem question="Can Koi be used to support impact-focused financial or investment decision-making?">
Absolutely. Koi replaces guesswork with rigorous, traceable analysis that investment professionals can verify. Whether you're conducting due diligence on climate solutions, building impact-focused portfolios, or reporting to stakeholders on ESG outcomes, our platform delivers the transparent, comparable data that modern finance demands. From venture capital evaluating breakthrough technologies to institutional investors managing billion-dollar climate funds, Koi provides the data and provenance for impact-driven investment decisions.
</FaqItem>

</FaqSection>

<FaqSection title="Support & Business">

<FaqItem question="How can I become a partner or collaborator with Koi?">
...
<FaqItem question="Is there a self-service option for Koi?">
...
<FaqItem question="What level of guidance, support, and consulting is available?">
We meet you where you are in your climate analysis journey. From comprehensive onboarding and training for new users to white-glove expert forecasting services, our support scales with your needs and ambitions. Whether you need quick guidance navigating the platform or deep collaboration on complex portfolio analysis, our team of climate finance experts provides everything from documentation and training sessions to fully custom <ExternalLink url="https://koi.eco/pricing" linkText="expert forecasts (Rapid, Refined, Diligence)" />. We're here to help you get the most out of Koi, whether that's a quick onboarding or a deep collaboration on portfolio analysis.
</FaqItem>

<FaqItem question="Can Koi generate reports or visualizations for presentations?">
Koi turns your analysis into clear summaries, charts, and slide-ready materials. Export what you need for technical reports, board decks, or stakeholder updates. Our expanding reporting suite generates professional impact summaries and publication-ready charts -- whether you're presenting to technical teams, executive leadership, or external stakeholders.
</FaqItem>

<FaqItem question="Does Koi support allocation factors?">
Yes. Our Collections Feature makes allocation factors incredibly flexible. Apply percentages to any collection, nest collections within others, and view your data through multiple lenses -- from sensitivity analysis probabilities to company-specific allocations to overall portfolio weightings. This flexibility reflects the complexity of real-world investment decisions and risk scenarios.
</FaqItem>

<FaqItem question="What is Koi's carbon intensity (CI) and life cycle analysis (LCA) library?">
Koi maintains a curated library of life cycle assessment (LCA) data, the carbon intensity values it produces, and the market data needed to use them in impact modeling. For coverage, structure, and how it differs from raw LCA databases, see the [Life Cycle Assessment (LCA) Library](/docs/data-and-methodology/lca-library).
</FaqItem>

<FaqItem question="How can we create dynamic impact where carbon intensities, allocation factors, and other variables change over time?">
Koi makes time-based modeling intuitive. Dynamic data is native within our forecasting engine, automatically handling evolving carbon intensities, technology improvements, and market changes over time. When you only have sparse data points, Koi intelligently interpolates using multiple methods to maintain analytical rigor. While allocation factors aren't currently dynamic, this capability is on our roadmap (<ExternalLink url="https://product.koi.eco" linkText="tell us about your use case" /> and we'll prioritize accordingly).
</FaqItem>

<FaqItem question="How does Koi handle cumulative vs. discrete annual impacts?">
Simply click `View Options` to toggle between `Annual` and `Cumulative` views, set your date range, and Koi instantly recalculates your entire analysis. Whether you're showing year-over-year progress to operations teams or lifetime impact to investors, both Collections and Forecasts offer identical flexibility. No complex reconfiguration, just the right view for the right audience.
</FaqItem>
