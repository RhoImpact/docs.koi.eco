...
<Info>
Avoided emissions forecasts estimate the amount of greenhouse gas (GHG) emissions that are prevented or removed when a climate solution replaces what would have happened without it.
</Info>
