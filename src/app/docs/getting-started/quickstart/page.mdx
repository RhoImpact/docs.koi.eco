...
export const metadata = {
  title: 'Quickstart',
  description:
    'Step-by-step quickstart guide for Koi. Learn how to create collections, search climate solutions, build impact forecasts, and organize portfolio analyses.'
}
...
Get started with Koi's climate solution database and impact forecasting tools. This quickstart guide will walk you through exploring Koi's climate
...
<Warning> When you share a Collection, all subcollections and custom analyses within it are automatically shared. If you remove access to a Collection, access to all its child elements will also be revoked unless shared separately </Warning>
...
caption="Use the *Custom Analysis* functionality to add market data from the market data in a complete model (Fermentation-Based Protein-Rich Meat Alternatives here). Select the blue button to create a new available market."
/>
