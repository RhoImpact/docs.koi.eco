...
Koi’s **Organization** feature allows you to manage your team, set permissions, and control licenses. Whether you're an investor managing a portfolio or a company analyzing impact, the organization feature helps ensure the right people have access to the right data and tools.
