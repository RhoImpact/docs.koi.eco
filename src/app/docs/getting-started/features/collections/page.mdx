...
export const metadata = {
  title: 'Collections',
  description: 'Learn how to use Koi Collections to organize, group, and compare climate impact analyses across portfolios, scenarios, and market segments.',
}
...
<YouTubeEmbed
  videoId="IU5P-ZRdgAw"
  title="Collections Overview - Koi Platform"
  caption="Watch this overview to learn how Collections work in Koi"
/>
