...
{/*  - See [Sharing](../features/sharing) for more. */}
...
1. **Add Company Forecasts to the Collection**:
    * For each company in your portfolio, find a representative technology model in Koi by searching either by the company domain or technology name.
...
1. **Organize and Structure the Collection**:
...
1. **Select a Technology or Initiative**:
