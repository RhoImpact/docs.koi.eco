...
1. Hover over <span>Account (<i className="fa-regular fa-user"></i>)</span> in the navigation bar.
2. Click `Settings`.
...
**Groups** allow you to manage shared access more efficiently by organizing users into teams. Instead of adding users individually to each Custom Analysis or <InternalLink route="collections" linkText="Collection" />, you can share with an entire group at once. You can add users that are outside your organization.
...
4. **Share** a Collection or Custom Analysis with your group.
